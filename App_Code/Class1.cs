...
public class Class1
{
    ...
    public static string connstring = @"server = 120.78.197.104; database =cjjdayi; uid = sa; pwd = Propressntc811";  //设置连接数据库的代码是webconfig里面的cn那句,即:server=.;database=net05qingongzhuxue;uid=sa;pwd=;
