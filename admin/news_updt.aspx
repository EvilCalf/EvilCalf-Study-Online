<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_updt.aspx.cs" Inherits="news_updt" %>
	...
	<body>
		<form id="form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center" border="1">
				...
				<tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>首页图片:</FONT></td><td width='79%'><asp:textbox id='shouyetupian' Width='395px' runat='server'></asp:textbox>*<a href="javaScript:OpenScript('hsgupfile.aspx?Result=shouyetupian',500,30)"><img src='Images/Upload.gif' width='30' height='16' border='0' align='absmiddle' /></a><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>内容:</FONT></td><td width='79%'><dntb:WebEditor ID='content' runat="server" Skin="skin/xp/" systemFolder="admin/system_dntb/" /></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>类别:</FONT></td><td width='79%'><asp:textbox id='leibie' runat='server'></asp:textbox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorleibie" runat="server" ControlToValidate="leibie" ErrorMessage="必填"></asp:RequiredFieldValidator><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>标题:</FONT></td><td width='79%'><asp:textbox id='title' Width='395px' runat='server'></asp:textbox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidatortitle" runat="server" ControlToValidate="title" ErrorMessage="必填"></asp:RequiredFieldValidator></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>点击率:</FONT></td><td width='79%'><asp:textbox id='dianjilv' runat='server'></asp:textbox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatordianjilv" runat="server" ControlToValidate="dianjilv" ErrorMessage="必填"></asp:RequiredFieldValidator>
				<tr>
