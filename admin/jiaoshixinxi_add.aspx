	...
	<body>
		<form id="form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center"
				...
				<tr bgColor="#f1f8f5">
					<td colSpan="2">
						<div align="center"><font color="#000000">添加教师信息</font></div>
					</td>
				</tr>
			...
			<tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>头像:</FONT></td><td width='79%'>
				...
				<tr>
					...
					<td width="59%" height="25">
						<asp:button id="Button1" runat="server" Text="添加" onclick="Button1_Click"></asp:button><FONT face="宋体"></FONT></td>
				</tr>
				<tr>
					<td colSpan="2">
