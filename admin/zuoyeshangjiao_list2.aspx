            ...
            <tbody>
                ...
                <tr class="tr1">
                    <td style="padding-left: 5px; height: 25px">
                        &nbsp; 编号：<asp:TextBox ID=bianhao runat="server"></asp:TextBox> 作业名称：<asp:TextBox ID=zuoyemingcheng runat="server"></asp:TextBox> 成绩：<asp:TextBox ID=chengji runat="server"></asp:TextBox>
                ...
                NextPageText="下一页" PrevPageText="上一页" BackColor="#2461BF" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=issh HeaderText='是否优秀'><HeaderStyle Width="80px" /></asp:BoundColumn>
