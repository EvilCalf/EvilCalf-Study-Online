...
public partial class zhuceyonghu_updt : System.Web.UI.Page
{
    ...
    private void getdata(string sql)
    {
        ...
        if (result != null)
        {
            if (result.Tables[0].Rows.Count > 0)
            {
              ...
              //  QQ.Text = result.Tables[0].Rows[0]["QQ"].ToString().Trim();
          //      touxiang.Text = result.Tables[0].Rows[0]["touxiang"].ToString().Trim();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sql = "update yonghuzhuce set yonghuming='" + yonghuming.Text.ToString().Trim() + "',mima='" + mima.Text.ToString().Trim() + "',xingming='" + xingming.Text.ToString().Trim() + "',dianhua='" + dianhua.Text.ToString().Trim() + "',youxiang='" + youxiang.Text.ToString().Trim() + "',shenfenzheng='" + shenfenzheng.Text.ToString().Trim() + "',dizhi='" + dizhi.Text.ToString().Trim() + "',xingbie='" + xingbie.Text.ToString().Trim() + "',beizhu='" + beizhu.Text.ToString().Trim() + "' where id=" + Request.QueryString["id"].ToString().Trim();
        int result;
