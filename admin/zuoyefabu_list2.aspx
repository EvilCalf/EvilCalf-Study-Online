            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" BackColor="#2461BF" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=bianhao HeaderText='编号'></asp:BoundColumn><asp:BoundColumn DataField=zuoyemingcheng HeaderText='作业名称'></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="要求内容"><ItemTemplate><a href='<%#DataBinder.Eval(Container.DataItem, "yaoqiuneirong") %>' target='_blank'>下载</a></ItemTemplate></asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="完成时间"><ItemTemplate><%# riqigeshi(DataBinder.Eval(Container.DataItem, "wanchengshijian"))%></ItemTemplate><HeaderStyle Width="100px" /></asp:TemplateColumn><asp:BoundColumn DataField=faburen HeaderText='发布人'></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn HeaderText="公布答案">
                               		<ItemTemplate>
                                    	<a href='zuoyefabu_updt2.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>'>公布答案</a>
                                	</ItemTemplate>
								<HeaderStyle Width="100px" />
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="查看答案"><ItemTemplate><a href='<%#DataBinder.Eval(Container.DataItem, "daan") %>' target='_blank'>下载</a></ItemTemplate></asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="删除">
                                	<ItemTemplate>
                                    	<a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=zuoyefabu&npage=zuoyefabu_list2.aspx' onclick="return confirm('确定要删除？')">删除</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>
