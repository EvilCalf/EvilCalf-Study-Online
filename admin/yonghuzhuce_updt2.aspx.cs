...
public partial class yonghuzhuce_updt2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sql = "update yonghuzhuce set yonghuming='" + yonghuming.Text.ToString().Trim() + "',mima='" + mima.Text.ToString().Trim() + "',xingming='" + xingming.Text.ToString().Trim() + "',dianhua='" + dianhua.Text.ToString().Trim() + "',youxiang='" + youxiang.Text.ToString().Trim() + "',touxiang='" + touxiang.Text.ToString().Trim() + "',shenfenzheng='" + shenfenzheng.Text.ToString().Trim() + "',dizhi='" + dizhi.Text.ToString().Trim() + "',xingbie='" + xingbie.Text.ToString().Trim() + "',beizhu='" + beizhu.Text.ToString().Trim() + "' where yonghuming='" + Session["username"].ToString().Trim() + "'";
        int result;
