...
public partial class zuoyefabu_add : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            yaoqiuneirong.Text = Session["path"].ToString();
        }
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        string sql;
        sql="insert into zuoyefabu(bianhao,zuoyemingcheng,yaoqiuneirong,wanchengshijian,faburen) values('"+bianhao.Text.ToString().Trim()+"','"+zuoyemingcheng.Text.ToString().Trim()+"','"+yaoqiuneirong.Text.ToString().Trim()+"','"+wanchengshijian.Text.ToString().Trim()+"','"+faburen.Text.ToString().Trim()+"') ";
        int result;
