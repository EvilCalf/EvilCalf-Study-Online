...
<head id="Head1" runat="server">
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>网站名称:</FONT></td><td width='79%'><asp:TextBox ID='wangzhanmingcheng' runat='server'></asp:TextBox></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>网址:</FONT></td><td width='79%'><asp:TextBox ID='wangzhi' runat='server'></asp:TextBox></td></tr>
