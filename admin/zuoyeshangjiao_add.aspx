<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zuoyeshangjiao_add.aspx.cs" Inherits="zuoyeshangjiao_add" %>
	...
	<body>
		<form id="form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center" border="1">
			    ...
			    <tr>
                    <td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>内容:</FONT></td><td width='79%'><asp:textbox id='neirong' Width='395px' runat='server'></asp:textbox>&nbsp;<a href="javaScript:OpenScript('hsgupfile.aspx?Result=neirong',500,30)"><img src='Images/Upload.gif' width='30' height='16' border='0' align='absmiddle' /></a></td>
                </tr>
			...
			<tr style="display:none"><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>成绩:</FONT></td><td width='79%'><asp:TextBox ID='chengji' runat='server'></asp:TextBox></td></tr>
