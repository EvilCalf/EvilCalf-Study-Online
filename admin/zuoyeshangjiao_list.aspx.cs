...
public partial class zuoyeshangjiao_list : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (bianhao.Text.ToString().Trim()!="" ){ sql=sql+" and bianhao like '%" + bianhao.Text.ToString().Trim() + "%'";}if (zuoyemingcheng.Text.ToString().Trim()!="" ){ sql=sql+" and zuoyemingcheng like '%" + zuoyemingcheng.Text.ToString().Trim() + "%'";}if (shangjiaoren.Text.ToString().Trim()!="" ){ sql=sql+" and shangjiaoren like '%" + shangjiaoren.Text.ToString().Trim() + "%'";}if (chengji.Text.ToString().Trim()!="" ){ sql=sql+" and chengji like '%" + chengji.Text.ToString().Trim() + "%'";}
