                ...
                <td align="left" style="height: 17px">
                    &nbsp;<table align="center" border="1" bordercolordark="#9cc7ef" bordercolorlight="#145aa0"
                        ...
                        <tr bgcolor="#4296e7">
                            <td colspan="1">
                                <div align="center">
                                    <font color="#ffffff">管理员用户列表</font></div>
                            </td>
                        </tr>
                        <tr>
                            <td width="79%">
                                &nbsp;<asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" Height="139px" PageSize="6" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None">
                                    <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                    <PagerStyle NextPageText="上一页" PrevPageText="下一页" BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
