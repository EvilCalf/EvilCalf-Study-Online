...
<!-- 
            ...
            function ReturnDetail(FilePathD) {
                var _TBIN = document.all("Label1").Text;                        // 从子页面控件中获取父页面控件的ID（load时保存的）  
                var obj_TBIN = eval("window.opener.document.all('" + _TBIN + "')");  // 在页面中查找到父页面控件     
                obj_TBIN.Text = FilePathD;                                            // 把返回值赋到父页面控件中 
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form id="formupfile" runat="server">
    <div>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="30"  style="width: 83px">选择文件：</td>
     ...
     <tr>
        ...
        <td style="width: 332px; height: 30px">
            <a onclick="ReturnDetail('uppic/<%=fname %>');">
                &nbsp;
                 &nbsp;</a></td>
      </tr>
    </table>
